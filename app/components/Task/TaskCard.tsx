...
interface TaskCardProps {
  task: Task;
  index: number;
  onEdit?: (task: Task) => void; // Optional callback for edit functionality
}
...
//           {...provided.draggableProps}
//           {...provided.dragHandleProps}
//           className={`bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-3 hover:shadow-md transition-all duration-200 cursor-pointer group ${
//             snapshot.isDragging ? "shadow-lg transform rotate-3 scale-105 z-50" : ""
//           }`}
//           style={{
//             ...provided.draggableProps.style,
//             // Ensure proper transform when dragging
